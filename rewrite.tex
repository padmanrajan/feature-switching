...
utterance and test utterance. Preprocessing steps to reduce channel variablity
including i-vector length normalization \cite{garciaRomero}, 
linear discriminant analysis (LDA) and within-class covariance
normalization (WCCN) are applied to the i-vectors.
...
Are you using Eucledian also? I thought all results are with cosine.

The four different baseline systems developed in this framework are referred as 
ivec-MFC-male, ivec-MFC-female, ivec-MGD-male and ivec-MGD-female.
...
What is the devel data for score norm?

\textbf{Score-level fusion:} The traditional way of combining information from
multiple feature representations is to combine them either at the feature level
or at the score level. In our experiments, this procedure is applied to both the
GMM-UBM system, and the i-vector system. The fusion scores are a linear
combination of the MFCC and MODGDF scores. A line search is performed to find
the optimal weighing parameter. These systems are denoted as SF-GMM-male,
SF-GMM-fem, SF-ivec-male and SF-ivec-fem. The performance of the fusion systems
are given in Table \ref{tab:eer}.
...
verified using different feature representations.  Experimental evaluation of
feature-switching is done in both GMM-UBM and i-vector frameworks. The details
...
constituent systems for feature-switching. This is shown in Figure \ref{fig:systemArch2}. For each enrollment
speaker, the optimal feature is determined from the enrollment utterance, as described in section
...
The weighting parameter $\alpha$ is used as a tradeoff between mutual information and
...
Out of 1402 male  and 1758 female speakers in the SRE 2010 dataset, the
optimal features were as follows

Give table here.

634 male  and 641 female trials chose MODGDF and remaining chose MFCC as their optimal feature.
...
Out of 1402 male and 1758 female training data, 26 and 1673 trials chose MODGDF
as their optimal feature respectively.

The feature-switching based i-vector systems are denoted as FS-ivec-male and
FS-ivec-female. The resulting EERs for these are also described in table
\ref{tab:eer}.
...
\cline{3-8}
\multicolumn{1}{l}{} & \multicolumn{1}{l|}{} & \multicolumn{3}{c|}{UBM-GMM Framework} & \multicolumn{3}{c|}{i-Vector Frmaework} \\ \hline
\multicolumn{1}{|c|}{Gender} & Condition & \begin{tabular}[c]{@{}c@{}}Best Baseline \\ EER\end{tabular} & \begin{tabular}[c]{@{}c@{}}Feature \\ Switching\\ EER\end{tabular} & \begin{tabular}[c]{@{}c@{}}Speaker Count\\ (MGD/MFCC)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Best Baseline \\ EER\end{tabular} & \begin{tabular}[c]{@{}c@{}}Feature\\  Switching\\ EER\end{tabular} & \begin{tabular}[c]{@{}c@{}}Speaker Count\\ (MGD/MFCC)\end{tabular} \\ \hline
\multicolumn{1}{|c|}{\multirow{5}{*}{Male}} & C5 & 17.27 (MFC) & {\bf 10.48} & 168/187 & 5.10 (MFC) & {\bf 3.56} & 8/352 \\ \cline{2-8} 
\multicolumn{1}{|c|}{} & C6 & 18.09 (MFC) & {\bf 12.32} & 113/34 & 6.20 (MFC) & {\bf 4.86} & 6/146 \\ \cline{2-8} 
\multicolumn{1}{|c|}{} & C7 & 11.65 (MGD) & {\bf 9.06} & 96/53 & 7.06 (MGD) & {\bf 5.57} & 7/147 \\ \cline{2-8} 
\multicolumn{1}{|c|}{} & C8 & 11.82 (MFC) & {\bf 9.4} & 64/52 & 2.17 (MFC) & {\bf 1.36} & 8/116 \\ \cline{2-8} 
\multicolumn{1}{|c|}{} & C9 & 4.55 (MFC) & {\bf 3.21} & 67/48 & 3.13 (MFC) & {\bf 2.48} & 4/115 \\ \hline
