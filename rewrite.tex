...
\centering
\begin{tabular}{l}
\hline {\bf Algorithm 1: MODGDF Extraction} \\
\hline \hline 
1. {\bf Input:} A frame of speech signal $x(n)$. \\
\: \: {\bf Output:} MODGDF features c(n). \\
...
are subjected to T-normalization \cite{tnorm}. True and 
impostor scores are identified from the ground truth and
EER is determined. The EERs of these baseline systems are
listed in the Table \ref{tab:eer}.
...
Out of 1402 male  and 1758 female speakers in the SRE 2010 dataset, the optimal features were as follows
...
734 male  and 641 female trials chose MODGDF and remaining
chose MFCC as their optimal feature. The two feature-switching
systems are developed in this framework are denoted as 
...
{EF-UBM-Male} & 17.97 & 20.22 & 12.84 & 15.94 & 10.14\\ \hline
