...
7.86\% and 10.16\% for the i-vector case. The condition-wise improvements for male and female 
trials in both UBM-GMM and i-vector case are given in Table~\ref{tab:relativePerformance}.
...
improvement is 28.92\% for male trials and 1.85\% for female trials in UBM-GMM case and 
26.19\% and 15.74\% in i-vector case. The only exception is in condition C6 
